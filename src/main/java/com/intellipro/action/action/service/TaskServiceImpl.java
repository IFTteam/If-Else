...
import com.intellipro.action.action.Repository.*;
import com.intellipro.action.action.controller.EventWebhookController;
import com.intellipro.action.action.controller.TimeEventController;
import com.intellipro.action.action.entity.*;
import com.intellipro.action.action.tasks.CMTExecutor;
...
//        }
        ...
        while (task.getTaskStatus() == 0) {
            for (Audience audience: allAudience) {
                ...
                if (currentType.equals(eventType)) {
                    ...
                    audienceList1.add(audience.getAudienceId());
        ...
        for (Audience audience : restAudience) {
            Long Id = audience.getAudienceId();
...
// -------------------------------------- first name --------------------------------------
        if (property.equals("first name")) {
            if (condition.equals("is")) {
                for (Audience audience : listOfAudiences) {
                    if (audience.getFirst_name() == null) {
                        continue;
                    }
                    if (audience.getFirst_name().equals(value)) {
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("contains")) {
                for (Audience audience : listOfAudiences) {
                    ...
                    if (audience.getFirst_name().contains(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("starts with")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getFirst_name().startsWith(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("ends with")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getFirst_name().endsWith(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("is greater than")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getFirst_name().compareTo(value) > 0){
                        haveProperty.add(audience);
                    }
                }
            }
...
// -------------------------------------- last name --------------------------------------
        if (property.equals("last name")) {
            if (condition.equals("is")) {
                for (Audience audience : listOfAudiences) {
                    if (audience.getLast_name() == null) {
                        continue;
                    }
                    if (audience.getLast_name().equals(value)) {
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("contains")) {
                for (Audience audience : listOfAudiences) {
                    ...
                    if (audience.getLast_name().contains(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("starts with")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getLast_name().startsWith(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("ends with")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getLast_name().endsWith(value)){
                        haveProperty.add(audience);
                    }
                }
            }
            ...
            if (condition.equals("is greater than")) {
                for( Audience audience: listOfAudiences) {
                    ...
                    if (audience.getLast_name().compareTo(value) > 0){
                        haveProperty.add(audience);
                    }
                }
            }
